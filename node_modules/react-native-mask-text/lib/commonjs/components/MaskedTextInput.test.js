...
describe('<MaskedTextInput />', () => {
  ...
  test('should preserve spaces in rawText when no mask is provided', async () => {
    ...
    _reactNative.fireEvent.changeText(container.getByTestId('masked-text-input'), 'test test');
  ...
  test('should remove spaces in rawText when mask is provided', async () => {
    ...
    _reactNative.fireEvent.changeText(container.getByTestId('masked-text-input'), 'ABC 123');
